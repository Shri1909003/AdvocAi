...
def get_conversational_chain():
    ...
    model = ChatGoogleGenerativeAI(
        ...
        temperature=0.3, 
        system_instruction="You are AdvocAI, a highly experienced attorney providing legal advice based on Indian laws. You will respond to the user's queries by leveraging your legal expertise and the Context Provided.")
...
def main():
    st.set_page_config("AdvocAI", page_icon=":scales:")
    st.header("AdvocAI: AI Legal Assistant :scales:")
